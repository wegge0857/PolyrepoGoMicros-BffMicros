...
type Server_GRPC struct {
	...
	Addr          string                 `protobuf:"bytes,2,opt,name=addr,proto3" json:"addr,omitempty"`
	Timeout       *durationpb.Duration   `protobuf:"bytes,3,opt,name=timeout,proto3" json:"timeout,omitempty"`
	EtfAddr       string                 `protobuf:"bytes,4,opt,name=etf_addr,json=etfAddr,proto3" json:"etf_addr,omitempty"`                     // 新增
...
func (x *Server_GRPC) GetEtfAddr() string {
	if x != nil {
		return x.EtfAddr
	}
	return ""
...
func (x *Server_GRPC) GetUserAddr() string {
	if x != nil {
		return x.UserAddr
	}
	return ""
...
func (x *Server_GRPC) GetLocalEtfAddr() string {
	if x != nil {
		return x.LocalEtfAddr
	}
	return ""
}
...
const file_internal_conf_conf_proto_rawDesc = "" +
	...
	"\x0flocal_user_addr\x18\a \x01(\tR\rlocalUserAddr\"\xdd\x02\n" +
	"\x04Data\x125\n" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeoutB\x1eZ\x1cbffMicros/internal/conf;confb\x06proto3"
